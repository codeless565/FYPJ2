...
public class CStateBossRageAttack : IStateBase
{
    ...
    IEnemy m_Owner;
    GameObject Bullet = (GameObject)Resources.Load("Projectiles/EnemyExplosiveNote");

    public CStateBossRageAttack(GameObject _go)
    {
        m_GO = _go;
